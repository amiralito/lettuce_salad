...
```{r}
c3_select_residues <- read_csv("/path/to/structure/Lactuca_sativa_Helixer_NC_056630.2_001736.1_CNL Annotations.csv")
...
c1_select_residues <- read_csv("/path/to/structure/Lactuca_sativa_Helixer_NC_056630.2_000504.1_NL Annotations.csv")
